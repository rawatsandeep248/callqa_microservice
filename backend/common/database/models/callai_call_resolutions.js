...
class CallaiCallResolutions {
    ...
    async defineModel(table) {
        const CallaiCallResolutions = this.sequelize.define('callai_call_resolutions', {
            id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
            uid: { type: Sequelize.STRING, allowNull: false },
            authentication_method: { type: Sequelize.STRING },
            authentication_status: { type: Sequelize.STRING },
            resolution_status: { type: Sequelize.STRING },
            completion_type: { type: Sequelize.STRING },
        ...
        return { SEQUELIZE: this.sequelize, CALLAICALLRESOLUTIONS: CallaiCallResolutions };
    }
...
module.exports = CallaiCallResolutions